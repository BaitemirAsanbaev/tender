  ...
  return (
    <div className={classes.wrap}>
      <div className={classes.choose}>
        <div className={classes.active}><Link to="/rate/ministr/">по Министерствам</Link></div>
        ...
        <div><Link to="/rate/budget/">по Бюджету</Link></div>
      </div>
